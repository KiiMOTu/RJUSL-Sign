...
# 🚀 Starting RJUSL Signing...
printf "🚀 Starting RJUSL Signing...\n\n"
...
if [ -f "$CERT_PATH" ] && [ -r "$CERT_PATH" ]; then
    ...
    printf "💡 Tip: RJUSL Signing will still start, but document signing will be unavailable\n"
...
printf "🌟 Starting RJUSL Signing server...\n"
